...
# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv1D(64, 2, activation='relu', padding='same', input_shape=(9,1)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                    ...
                    #   filepath= path + "MCP/keras30_ModelCheckPoint3.hdf5"
                      filepath= filepath + "k51_04_dacon_ddarung_" + date + "_" + filename)
...
# Conv1D
# mse :  1926.3482666015625
# RMSE :  43.89018198478869