...
# 2. 모델
model = Sequential()
model.add(Conv1D(64, 2, activation='relu', padding='same', input_shape=(32*3,32)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                      save_best_only=True,
                      filepath= filepath + "k51_13_cifar10_" + date + "_" + filename)
...
# Conv1D
# loss :  1.227962851524353
# acc :  0.5698999762535095
