...
# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv1D(64, 2, activation='relu', padding='same', input_shape=(13,1)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                    ...
                    #   filepath= path + "MCP/keras30_ModelCheckPoint3.hdf5"
                      filepath= filepath + "k51_01_boston_" + date + "_" + filename)
...
# Conv1D
# mse :  17.9056453704834
# R2 스코어:  0.8174364224106885