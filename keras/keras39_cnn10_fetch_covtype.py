...
x_train = x_train.reshape(406708, 6, 9, 1)
x_test = x_test.reshape(174304, 6, 9, 1)
print(x_train.shape, x_test.shape)      # (406708, 6, 9, 1) (174304, 6, 9, 1)

# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv2D(64, (2, 2), activation='relu', padding='same',input_shape=(6, 9, 1)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                    ...
                    #   filepath= path + "MCP/keras30_ModelCheckPoint3.hdf5"
                      filepath= filepath + "k39_cnn10_fetch_covtype_" + date + "_" + filename)
