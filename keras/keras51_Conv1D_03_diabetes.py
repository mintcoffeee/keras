...
# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv1D(64, 2, activation='relu', padding='same', input_shape=(5,2)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                    ...
                    #   filepath= path + "MCP/keras30_ModelCheckPoint3.hdf5"
                      filepath= filepath + "k51_03_diabetes_" + date + "_" + filename)
...
# LSTM
# mse :  2658.41943359375
# R2 스코어:  0.49220027149495393

# Conv1D
# mse :  2741.097900390625
# R2 스코어:  0.4764073705172357