...
# 2. 모델 구성(순차형)
model = Sequential()
model.add(Conv1D(64, 2, activation='relu', padding='same', input_shape=(8,1)))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                    ...
                    #   filepath= path + "MCP/keras30_ModelCheckPoint3.hdf5"
                      filepath= filepath + "k51_02_california_" + date + "_" + filename)
...
# LSTM
# mse :  0.29021671414375305
# R2 스코어:  0.7748659746886816

# Conv1D
# mse :  0.2727816700935364
# R2 스코어:  0.7883909980271763