...
# 2. 모델
model = Sequential()
model.add(Conv2D(filters=256, kernel_size=(3,3), input_shape=(32, 32, 3),
                 activation='relu'))
...
mcp = ModelCheckpoint(monitor="val_loss", mode="auto", verbose=1,
                      save_best_only=True,
                      filepath= filepath + "k34_mnist3_" + date + "_" + filename)
...
"""
loss :  2.2027597427368164
acc :  0.43970000743865967
"""